...
COURSE_OPTIONS = [
    {
        ...
        "turma": "PRAÇA STUART ANGEL JONES",
        "dias_aula": "Domingo",
        "horario": "17h",
        "data_inicio": "19/04/2026",
        "encerramento": "⚠️Em caso de chuva pode ser cancelado",
        "endereco_curso": "📍Praça Stuart Angel Jones: R. Boa Esperança, Portuguesa, RJ - 21941-570",
    },
]
                    ...
                    <div class="hero-grid">
                        <div class="hero-card">
                                ...
                                <p class="hero-subtitle">
                                    Evento Gratuito:<br>
                                        Aulão de todos os ritmos com - Prof. Angélica e Prof. Andinho<br>
                                        📍Praça Stuart Angel Jones: R. Boa Esperança, Portuguesa, RJ - 21941-570
                                </p>
                        ...
                        <div class="review-layout">
                            ...
                            <div class="review-box full">
                                <div class="review-info-text" style="margin-bottom:10px; color:#a14f45; font-size:0.98rem; text-align:left;">
                                    <strong>Elegibilidade:</strong> Este evento é destinado a pessoas interessadas em dança que residem na Ilha do Governador ou região próxima.
                                </div>
                                <label class="review-check" for="confirma_dados">
                                    ...
                                    <span>
                                        Confirmo que resido na Ilha do Governador ou região próxima e tenho interesse em participar do evento.<br>
